...
export function EquipmentTableHeader({
  ...
  return (
    <div className="bg-muted/30 border-b border-border sticky top-0 z-10">
      <div className="grid grid-cols-[40px_40px_60px_minmax(200px,1fr)_minmax(120px,200px)_minmax(100px,150px)_100px_120px_120px] gap-2 lg:gap-3 px-2 lg:px-4 py-3 items-center text-xs font-medium text-muted-foreground uppercase tracking-wider">

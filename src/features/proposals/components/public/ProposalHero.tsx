  ...
  return (
    <section ref={sectionRef} className='relative min-h-[92vh] flex flex-col justify-center items-start text-left proposal-content-px pt-40 pb-20'>
      ...
      <div className='absolute inset-0 pointer-events-none overflow-hidden'>
        <img src='/proposal-assets/bg.png' alt='' className='absolute top-1/2 right-0 -translate-y-1/2 max-h-[110%] w-auto object-contain opacity-10' />
        <div ref={maskRef} className='absolute inset-0' style={{ maskImage: 'none', WebkitMaskImage: 'none' }}>
          <img src='/proposal-assets/bg.png' alt='' className='absolute top-1/2 right-0 -translate-y-1/2 max-h-[110%] w-auto object-contain opacity-50' />
        </div>

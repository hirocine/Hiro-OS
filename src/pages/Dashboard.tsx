...
export default function Dashboard() {
  ...
  return (
    <div className="container mx-auto p-4 lg:p-6 space-y-6 lg:space-y-8 animate-fade-in">
      ...
      <div className="bg-gradient-card rounded-lg p-4 lg:p-6 shadow-elegant">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 lg:gap-4">
          ...
          <div className="text-center p-3 bg-background/50 rounded-lg">
            <p className="text-xs lg:text-sm text-muted-foreground">+1 Ano de Uso</p>
            <p className="text-lg lg:text-2xl font-bold text-warning">{equipmentByAge.over1Year}</p>
            <p className="text-xs text-muted-foreground mt-1">Equipamentos</p>
          </div>
          <div className="text-center p-3 bg-background/50 rounded-lg">
            <p className="text-xs lg:text-sm text-muted-foreground">+2 Anos de Uso</p>
            <p className="text-lg lg:text-2xl font-bold text-warning">{equipmentByAge.over2Years}</p>
            <p className="text-xs text-muted-foreground mt-1">Equipamentos</p>
          </div>
          <div className="text-center p-3 bg-background/50 rounded-lg">
            <p className="text-xs lg:text-sm text-muted-foreground">+3 Anos de Uso</p>
            <p className="text-lg lg:text-2xl font-bold text-destructive">{equipmentByAge.over3Years}</p>
            <p className="text-xs text-muted-foreground mt-1">Equipamentos</p>
          </div>
        </div>
      </div>

-- Correção completa dos equipamentos "em uso" - Limpeza e prevenção
...
-- Etapa 4: Função de sincronização manual para manutenção
...
SELECT manual_sync_equipment_status() as equipamentos_corrigidos;

-- Criar trigger atualizado para substituir o antigo
DROP TRIGGER IF EXISTS update_equipment_status_on_loan_change ON loans;

-- Comentário: O novo trigger sync_equipment_on_loan_change substitui completamente
-- o trigger update_equipment_simplified_status que já existe